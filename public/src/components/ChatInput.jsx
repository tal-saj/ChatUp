...
return (
  <div className="relative px-3 pb-4 pt-2 bg-transparent">
    {/* Glassmorphic input bar – now full width */}
    <div
      className={`
    ...
    {/* Emoji Picker – needs wider positioning now */}
    {showEmojiPicker && (
      <div
        ref={pickerRef}
        className="
          absolute bottom-full left-3 right-3 mb-4
          z-50 
          shadow-2xl shadow-slate-400/30
          rounded-2xl overflow-hidden
          border border-slate-200/60
          // removed mx-auto max-w-md → let it follow parent width with small inset
        "
      >
        <Picker
